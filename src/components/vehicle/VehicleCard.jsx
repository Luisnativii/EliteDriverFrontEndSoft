    ...
    {renderStatus()}
          ...
          {isAdmin && (
            <div className="flex gap-2 pt-4 border-t border-gray-100">
              <button
                onClick={handleEdit}
                className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-700 hover:text-white cursor-pointer  transition-colors duration-200"
              >
              ...
              <button
                ...
                className="flex-1 inline-flex items-center justify-center cursor-pointer px-3 py-2 border border-red-300 text-sm font-medium rounded-md text-red-700 bg-white hover:bg-red-700 hover:text-white transition-colors duration-200"
              >
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2 border cursor-pointer border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors duration-200 disabled:opacity-50"
              >
                Cancelar
              </button>
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2 cursor-pointer bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors duration-200 disabled:opacity-50 flex items-center justify-center"
              >
                {isDeleting ? (
                  <>
