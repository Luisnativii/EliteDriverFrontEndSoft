                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed">
                           te brindamos la libertad de moverte a tu ritmo. Ya sea que viajes por negocios o placer, puedes elegir el vehículo ideal para tu aventura y recibirlo donde lo necesites: en tu hotel, casa, oficina o cualquier punto de encuentro. Nuestro servicio está diseñado para adaptarse a ti, sin complicaciones ni filas.
                        </p>
